 ...
 * 
 */
package br.com.skylane.voicer.view;
...
public class STextureRender {
	...
	private final float[] mTriangleVerticesData = {
			// X, Y, Z, U, V
			-1.0f, -1.0f, 0, 0.f, 0.f, 1.0f, -1.0f, 0, 1.f, 0.f, -1.0f, 1.0f,
			0, 0.f, 1.f, 1.0f, 1.0f, 0, 1.f, 1.f, };
	...
	public void drawFrame(SurfaceTexture st) {
		...
		// IMPORTANT: on some devices, if you are sharing the external texture
		// between two
		// contexts, one context may not see updates to the texture unless you
		// un-bind and
		// re-bind it. If you're not using shared EGL contexts, you don't need
		// to bind
		// texture 0 here.
